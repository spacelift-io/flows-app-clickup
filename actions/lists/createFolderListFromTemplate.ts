...
// Input schema for Create Folder List From Template
const inputSchema = {
  folder_id: {
    name: "Folder ID",
...
// Output schema for Create Folder List From Template
const outputSchema = {
  type: "object",
  description:
...
export default {
  name: "Create Folder List From Template",
  description: "Creates create folder list from template in ClickUp",
  category: "Lists",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { folder_id, template_id, ...inputData } =
          input.event.inputConfig;
        const endpoint = `/v2/folder/${folder_id}/list_template/${template_id}`;
